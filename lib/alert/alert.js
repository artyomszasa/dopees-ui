...
const view = "<style>:host{display:block;position:fixed;z-index:9999}dope-dialog{--dialog-width: 20rem}p{margin:0}\n\n/*# sourceMappingURL=alert.css.map */</style><dope-dialog caption=\"[[caption]]\"><p slot=\"body\">[[message]]</p><div class=\"buttons\" slot=\"buttons\"><dope-button label=\"Ok\" on-click=\"onOkClick\"></dope-button></div></dope-dialog>";
/**
